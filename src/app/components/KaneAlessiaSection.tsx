...
const stats = [
  { value: "3M+",     label: "Entrepreneurs Trained\nAcross 80 Countries" },
  { value: "$500M+",  label: "Revenue Built Across\nTheir Own Companies" },
  { value: "$2B+",    label: "Value Created\nFor Their Clients" },
  { value: "3x",      label: "Best-Selling\nAuthors" },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        >
          ...
          <div className="flex-1 flex flex-col gap-6 lg:pr-8 z-10">
            ...
            >
              Silicon Valley's most sought-after AI business mentors — 3x best-selling authors, award-winning serial entrepreneurs, and the{" "}
