...
const kaneHighlights = [
  ...
  "Training Partner to Richard Branson & Robert Kiyosaki",
  "Silicon Valley AI Systems Architect",
  "Built & Deployed Agent Frameworks for Real Businesses",
];

const alessiaHighlights = [
  "9 Companies Founded & Scaled",
  "$180M+ Total Revenue Generated",
  "Thousands of Entrepreneurs Mentored",
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-24 md:py-32 relative">
        ...
        <div className="text-center mb-20">
          ...
          >
            Meet the Silicon Valley AI Mentors Behind the{" "}
            <span
              style={{
          ...
          >
            ...
            <div className="p-7 flex flex-col gap-5 flex-1">
              <p style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.85 }}>
                Kane is renowned as one of the world's best AI business mentors, having assisted entrepreneurs and investors in nearly every industry and niche. His deep obsession with agent architecture and agentic operating systems has led him to{" "}
                <strong style={{ color: "rgba(255,255,255,0.9)", fontWeight: 600 }}>
                  build and deploy AI systems for real businesses every day.
                </strong>
              </p>
              <p style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.85 }}>
                He is a sought-after faculty member for{" "}
                <strong style={{ color: "rgba(255,255,255,0.9)", fontWeight: 600 }}>Tony Robbins' Business Mastery</strong>{" "}
                events and has keynoted alongside Richard Branson, Robert Kiyosaki, and dozens of other influential world leaders.
              </p>
          ...
          >
            ...
            <div className="p-7 flex flex-col gap-5 flex-1">
              ...
              <p style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.85 }}>
                ...
                Through two decades of building businesses, she has developed the frameworks and deployment playbooks that thousands of students now use to run their own operations.
              </p>
        ...
        <div className="text-center mt-16">
          ...
          >
            Ready to learn directly from the world's #1 AI business mentors?
          </p>
          <button
